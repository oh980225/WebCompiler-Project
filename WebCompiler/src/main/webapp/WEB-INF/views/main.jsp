			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Header -->
						<header id="header">
							<a class="main_logo" href="index.html"><img src="<%=request.getContextPath()%>/resources/images/main_logo.png" alt="메인페이지" width="25px" height="25px"/></a>
							<a class="header_problem" href="mycode.html"><img src="<%=request.getContextPath()%>/resources/images/header_problem.png" alt="문제 페이지" width="25px" height="25px"/>문제풀기</a>
							<a class="header_board" href="Q&A.html"><img src="<%=request.getContextPath()%>/resources/images/header_board.png" alt="게시판 페이지" width="25px" height="25px"/>자유게시판</a>
							<a class="header_signup" href="#"><img src="<%=request.getContextPath()%>/resources/images/header_signup.png" alt="회원가입" width="25px" height="25px"/><span>회원가입</span></a>
							<a class="header_signin" href="signin.html"><img src="<%=request.getContextPath()%>/resources/images/header_signin.png" alt="로그인" width="25px" height="25px"/><span>로그인</span></a>
						</header>
						<div class="inner">
							<!-- Banner -->
								<section id="banner">
